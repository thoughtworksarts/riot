...
public class AngerEndScreenController implements Initializable, ControlledScreen {
    ...
    private void goToNextScreen() {
    	ApplicationData.getSingleton().clearEmotionsRecord();
    	myController.loadScreen(MainScreen.SCREEN_CREDITS_1);
    }
